...
class CompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('system-mgmt/company/index', ['companys' => $companys]);
    }
    ...
    public function search(Request $request) 
    {
       ...
       $companys = $this->doSearchingQuery($constraints);
        
       return view('system-mgmt/company/index', ['companys' => $companys, 'searchingVals' => $constraints]);
    }
    ...
    private function validateInput($request) 
    {
        $this->validate($request, [
            'name' => 'required|max:60|unique:company'
        ]);
    }
